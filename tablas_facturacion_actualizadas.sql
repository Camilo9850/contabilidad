-- SQL file for e-commerce billing system tables - Updated version
...
CREATE TABLE clientes (
    ...
    nombre VARCHAR(50),
    apellido VARCHAR(50),          -- Agregada esta columna
    telefono VARCHAR(50),
    direccion VARCHAR(50),
    dni VARCHAR(50),
    celular VARCHAR(50),           -- Agregada esta columna
...
-- Tabla: `postulaciones` (agregada según tu error anterior)
